...
namespace testVue.Controllers
{
    ...
    public class ReportController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetTotalRevenueByUserTime([FromBody] TimeRequest request)
        {
            try
            {
        ...
        public async Task<IActionResult> GetTotalRevenueByUserTimeMonth([FromBody] TimeRequest request)
        {
            try
            {
                // Kiểm tra nếu `request` hoặc `Date` không được cung cấp hoặc không hợp lệ
        ...
        public async Task<IActionResult> GetTotalRevenueByCategoryTime(TimeRequest request)
        {
            try
            {
                // Kiểm tra nếu `request` hoặc `Date` không được cung cấp hoặc không hợp lệ
        ...
        public async Task<IActionResult> GetTotalRevenueByCategoryTimeMonth(TimeRequest request)
        {
            try
            {
                // Kiểm tra nếu `request` hoặc `Date` không được cung cấp hoặc không hợp lệ
        ...
        public async Task<IActionResult> GetTotalAmountByMonth([FromBody] TimeRequest monthRequest)
        {
            try
            {
